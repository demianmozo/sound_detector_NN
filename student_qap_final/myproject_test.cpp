...
int main(int argc, char **argv) {
    ...
    if (fin.is_open() && fpr.is_open()) {
      ...
      nnet::copy_data<float, input_t, 0, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(in, flatten_24_input);
      result_t layer17_out[N_LAYER_15];

            // hls-fpga-machine-learning insert top-level-function
            myproject(flatten_24_input,layer17_out);
    ...
    input_t flatten_24_input[N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1];
    nnet::fill_zero<input_t, N_INPUT_1_1*N_INPUT_2_1*N_INPUT_3_1>(flatten_24_input);
    result_t layer17_out[N_LAYER_15];
