...
HD_PWD='/home/student/Documents/laburar_aca/labs/lab08/01-Baremetal/Lab08-01/Lab08-01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MLZedboard_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MLZedboard_wrapper.tcl -notrace
